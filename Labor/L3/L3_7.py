...
def create_model(m_shape = 784):
    ...
    dropout = Dropout(0.1,noise_shape=None,seed=None)(inputs)
    output_1 = Dense(32, activation='relu', )(dropout)
    output_2 = Dense(64, activation='relu')(output_1)
    output_3 = Concatenate()([output_2, inputs])
    output_4 = Concatenate()([output_3, inputs])
