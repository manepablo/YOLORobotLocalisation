...
from keras.layers import BatchNormalization, Dropout,Activation, Input, Dense, Conv2D, MaxPooling2D, UpSampling2D, Conv2DTranspose, concatenate
from keras.models import Model

def getUNet(inputshape):
    ...
    conv10 = Conv2D(1, (3, 3), activation='softmax', padding='same')(conv9)    
